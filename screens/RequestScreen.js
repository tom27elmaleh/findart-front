...
export default function RequestScreen({ route }) {
  ...
  const submitRequest = () => {
    fetch("http://192.168.10.138:3000/requests/sendRequest", {
      method: "POST",
  ...
  return (
    ...
    <KeyboardAvoidingView  behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      ...
      <Text style={styles.artistName}>Demande à : <Text style={{color: "#2A9D8F"}}>{route.params.username}</Text></Text>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent>
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text>Votre demande a bien été envoyée. Vous recevrez une réponse par mail dans les 48h.</Text>
              <TouchableOpacity onPress={() => closeModal()} style={styles.btnBackHome}>
